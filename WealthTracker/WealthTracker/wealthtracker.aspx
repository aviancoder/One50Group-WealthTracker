                                ...
                                <table class="table table-borderless">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <asp:TextBox ID="InvestmentProperty1PurchaseYear" runat="server" class="form-control form-control-sm text-right one50group-formattednumber"></asp:TextBox></td>
                                            <td class="text-right">
                                                <asp:TextBox ID="InvestmentProperty2PurchaseYear" runat="server" class="form-control form-control-sm text-right one50group-formattednumber"></asp:TextBox></td>
                                            <td class="text-right">
                                                <asp:TextBox ID="InvestmentProperty3PurchaseYear" runat="server" class="form-control form-control-sm text-right one50group-formattednumber"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td><span>Value ($)</span></td>
                                            <td class="text-right">
                                                <asp:TextBox ID="InvestmentProperty1Value" runat="server" class="form-control form-control-sm text-right one50group-formattednumber"></asp:TextBox></td>
                                            <td class="text-right">
                                                <asp:TextBox ID="InvestmentProperty2Value" runat="server" class="form-control form-control-sm text-right one50group-formattednumber"></asp:TextBox></td>
                                            <td class="text-right">
                                                <asp:TextBox ID="InvestmentProperty3Value" runat="server" class="form-control form-control-sm text-right one50group-formattednumber"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td><span>Debt ($)</span></td>
                                            <td class="text-right">
                                                <asp:TextBox ID="InvestmentProperty1Debt" runat="server" class="form-control form-control-sm text-right one50group-formattednumber"></asp:TextBox></td>
                                            <td class="text-right">
                                                <asp:TextBox ID="InvestmentProperty2Debt" runat="server" class="form-control form-control-sm text-right one50group-formattednumber"></asp:TextBox></td>
                                            <td class="text-right">
                                                <asp:TextBox ID="InvestmentProperty3Debt" runat="server" class="form-control form-control-sm text-right one50group-formattednumber"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td><span>P&I Repayments Begin Year ($)</span></td>
                                            <td class="text-right">
                                                <asp:TextBox ID="InvestmentProperty1RepaymentsBeginYear" runat="server" class="form-control form-control-sm text-right one50group-formattednumber"></asp:TextBox></td>
                                            <td class="text-right">
                                                <asp:TextBox ID="InvestmentProperty2RepaymentsBeginYear" runat="server" class="form-control form-control-sm text-right one50group-formattednumber"></asp:TextBox></td>
                                            <td class="text-right">
                                                <asp:TextBox ID="InvestmentProperty3RepaymentsBeginYear" runat="server" class="form-control form-control-sm text-right one50group-formattednumber"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td><span>Years to Repay Debt</span></td>
                                            <td class="text-right">
                                                <asp:TextBox ID="InvestmentProperty1YearsToRepayDebt" runat="server" class="form-control form-control-sm text-right one50group-formattednumber"></asp:TextBox></td>
                                            <td class="text-right">
                                                <asp:TextBox ID="InvestmentProperty2YearsToRepayDebt" runat="server" class="form-control form-control-sm text-right one50group-formattednumber"></asp:TextBox></td>
                                            <td class="text-right">
                                                <asp:TextBox ID="InvestmentProperty3YearsToRepayDebt" runat="server" class="form-control form-control-sm text-right one50group-formattednumber"></asp:TextBox></td>
                                        </tr>
                                        <tr>
